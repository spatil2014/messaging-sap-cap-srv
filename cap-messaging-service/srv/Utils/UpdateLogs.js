...
const destinationServiceInstanceName = "cap-messaging-service-destination-service"
...
async function updateLog(vendor, msgType, documentType, documentRef, status, messageContent) {
    return new Promise(async (resolve, reject) => {
        ...
        try{
            let response = await axios.post(`${selfDest.URL}/msgself/log`, payloadToUpdateinLog, {
                headers: {
